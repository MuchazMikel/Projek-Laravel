...
Route::get('/biodata/edit/{biodata}', [App\Http\Controllers\BiodataController::class, 'edit'])->name('biodata.edit');
Route::put('/biodata/update/{biodata}', [App\Http\Controllers\BiodataController::class, 'update'])->name('biodata.update');
Route::delete('/biodata/delete/{biodata}', [App\Http\Controllers\BiodataController::class, 'destroy'])->name('biodata.destroy');
